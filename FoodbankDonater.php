	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <ul>
			 <li><a style="background: #F7F7F7" href="FoodbankDonater.php" style="background-color:white;">Donater</a></li>
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="110" style="text-align: center">Amount</td>
		<td width="110" style="text-align: center">Product</td>
...
$sql="SELECT * FROM foodbank_donater WHERE DonaterName='$name'";
	$result = $conn->query($sql);
}
else
{
// Retrieve data from database
$sql="SELECT * FROM foodbank_donater";
$result = $conn->query($sql);
}
