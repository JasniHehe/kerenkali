	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a style="background: #F7F7F7" href="#">Charity <i class="fas fa-caret-down"></i></a>
			 <ul>
			 <li><a href="CharityDonater.php" style="background-color:white;">Donater</a></li>
			 <li><a style="background: #F7F7F7" href="CharityTotal.php" style="background-color:white;">Total Amount</a></li>
			 </ul>
			 </li>
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> Charity Report  </p>
	<h3>&nbsp;</h3>
  <p align="center">
 Search: 
   <input type="text" name="year" id="name" placeholder="year">
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="149" style="text-align: center">Amount (RM)</td>
...
$sql="SELECT * FROM  charity_donater WHERE Date LIKE '$year-$month-%' ORDER BY id DESC";
	$result = $conn->query($sql);
}
else
{
// Retrieve data from database
$sql="SELECT * FROM  charity_donater ORDER BY id DESC";
$result = $conn->query($sql);
}
...
<?php
	...
	if(isset($_POST['search'])){
                $year = $_POST['year'];
                $month = $_POST['month'];
                $sql4 = "SELECT SUM(amount) AS Total FROM charity_donater WHERE Date LIKE '$year-$month-%'";
            }
            else{
                $sql4 = "SELECT SUM(amount) AS Total FROM charity_donater";
            }
            ...
            ?>
            <h2>Total Donation: RM<?php echo $total_revenue;?></h2><?php
}
$conn->close();
?>
