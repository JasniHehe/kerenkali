	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a style="background: #F7F7F7" href="AdminFeedback.php">Feedback</a></li>	
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> Feedback List </p>
	<h3>&nbsp;</h3>
  <p align="center">
 Search Date : 
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="110" style="text-align: center">Feedback</td>
...
?>
 ...
 <td height="20"><div align="center"><?php echo $i; ?>
	  ...
	  <td><div align="center"><?php echo $rows['feedback']; ?></div></td>
