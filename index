	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a href="Sign_in.html" style="background: #F7F7F7;">User</a></li>		
		...
		<div class="container">
		<form class="form" id="login" method="post" action="checkuser.php">
		...
		<div class="form__input-group">
			<input type="text" name="useremail" class="form__input" autofocus placeholder="Email">
			<div class="form__input-error-message"></div>
		  </div>
			<div class="form__input-group">
			<input type="Password" name="userpass" class="form__input" autofocus placeholder="Password">
			<div class="form__input-error-message"></div>
		  </div>
		  ...
		  <p class="form__text">
			...
			<p class="form__text">
			<a class="form__link" href="SignUpUser.html" id="linkCreateAccount">Don't have an account? Create account now for free!</a>
			</p>
		</form>
		</div>
