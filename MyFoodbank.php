	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a style="background: #F7F7F7" href="#.">My Donation <i class="fas fa-caret-down"></i></a>	
			 <ul>
			 <li><a href="MyCharity.php?Email=<?php echo $userEmail ?>" style="background-color:white;">Charity</a></li>
			 <li><a style="background: #F7F7F7" href="MyFoodbank.php?Email=<?php echo $userEmail ?>" style="background-color:white;">Foodbank</a></li>
			 </ul>
			 </li>
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> My Foodbank List </p>
	<h3>&nbsp;</h3>
  <p align="center">
 Search Date : 
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="126" style="text-align: center">Product</td>
		<td width="126" style="text-align: center">Amount</td>
      </tr>
<?php
include('dbconnect.php');
...
$sql="SELECT * FROM foodbank_donater WHERE DonaterEmail='$userEmail' and Date='$date'";
	$result = $conn->query($sql);
}
else
{
// Retrieve data from database
$sql="SELECT * FROM foodbank_donater WHERE DonaterEmail='$userEmail'";
$result = $conn->query($sql);
}
