	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <ul>
			 <li><a href="/hall.html" style="background-color:white;">Hall</a></li>
			 <li><a href="court.html" style="background-color:white;">Court</a></li>
			 </ul>
			 </li>
			 
			 <li><a style="background: #F7F7F7" href="#.">Donate <i class="fas fa-caret-down"></i></a>	
			 <ul>
			 <li><a href="fund.html" style="background-color:white;">Charity</a></li>
			 <li><a style="background: #F7F7F7" href="foodbank.html" style="background-color:white;">Foodbank</a></li>
			 </ul>
			 </li>
