	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a style="background: #F7F7F7" href="UserList.php">User</a></li>
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="110" style="text-align: center">Phone</td>
		<td width="110" style="text-align: center">Address</td>
...
?>
 ...
 <td height="20"><div align="center"><?php echo $i; ?>
	...
	<td><div align="center"><a href="RemoveUser.php?email=<?php echo $rows['Email']; ?>">Delete</a></div></td>
      </tr>
