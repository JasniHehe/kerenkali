...
?>
	...
	<nav>
		...
		<div class="container">
		<form class="form" id="createAccount" method="post" action="bookcourt.php">
		<h1 class="form__title">Book Court Now</h1>
		<div class="form__message form_message--error"></div>
			...
			<div class="form__input-group">
			<input style="display: block;width: 100%;padding: 0.75rem;box-sizing: border-box;border-radius: 4px;border: 1px solid #dddddd;outline: none;background: #eeeeee;transition: background 0.2s, border-color 0.2s;" list="court" name="court" autofocus placeholder="Court">
  			<datalist id="court">
