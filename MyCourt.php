	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a style="background: #F7F7F7" href="MyCourt.php?Email=<?php echo $userEmail ?>" style="background-color:white;">Court</a></li>
			 </ul>
			 </li>
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> My Court Booking List </p>
	<h3>&nbsp;</h3>
  <p align="center">
 Search Date : 
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="126" style="text-align: center">Court</td>
      </tr>
<?php
include('dbconnect.php');
...
$sql="SELECT * FROM court_booking WHERE Email='$userEmail' and Date='$date'";
	$result = $conn->query($sql);
}
else
{
// Retrieve data from database
$sql="SELECT * FROM court_booking WHERE Email='$userEmail'";
$result = $conn->query($sql);
}
