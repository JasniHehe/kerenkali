	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <ul>
			 <li><a style="background: #F7F7F7" href="AdminCourtBooking.php" style="background-color:white;">Booking List</a></li>
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> Court Booking List </p>
	<h3>&nbsp;</h3>
  <p align="center">
 Search Date : 
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="110" style="text-align: center">Court</td>
...
$sql="SELECT * FROM court_booking WHERE Date='$date'";
	$result = $conn->query($sql);
}
else
{
// Retrieve data from database
$sql="SELECT * FROM court_booking";
$result = $conn->query($sql);
}
...
?>
 ...
 <td height="20"><div align="center"><?php echo $i; ?>
	  ...
	  <td><div align="center"><?php echo $rows['Time']; ?></div></td>
		  <td><div align="center"><?php echo $rows['court']; ?></div></td>
<td><div align="center"><a href="RemoveCourtBooking.php?id=<?php echo $rows['id']; ?>">Delete</a></div></td>
      </tr>
