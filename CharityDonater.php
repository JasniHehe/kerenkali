	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <ul>
			 <li><a style="background: #F7F7F7" href="CharityDonater.php" style="background-color:white;">Donater</a></li>
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> Donater List </p>
	<h3>&nbsp;</h3>
  <p align="center">
 Search Name: 
  ...
  <table width="1086" height="53" border="1" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr>
		...
		<td width="110" style="text-align: center">Amount (RM)</td>
...
$sql="SELECT * FROM charity_donater WHERE Name='$name'";
	$result = $conn->query($sql);
}
else
{
// Retrieve data from database
$sql="SELECT * FROM charity_donater";
$result = $conn->query($sql);
}
