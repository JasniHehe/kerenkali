	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a style="background: #F7F7F7" href="#">Court <i class="fas fa-caret-down"></i></a>
			 <ul>
			 <li><a href="AdminCourtBooking.php" style="background-color:white;">Booking List</a></li>
			 <li><a style="background: #F7F7F7" href="CourtList.php" style="background-color:white;">Court List</a></li>
			 </ul>
			 </li>
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> Court List </p>
	<h3>&nbsp;</h3>
	<h3>&nbsp;</h3>
...
?>
 ...
 <td height="20"><div align="center"><?php echo $i; ?>
	  ...
	  <td><div align="center"><?php echo $rows['Name']; ?></div></td>
        <td><div align="center"><a href="RemoveCourt.php?Court=<?php echo $rows['Name']; ?>">Delete</a></div></td>
      </tr>
...
?>
  ...
  <button class="form_btn" style="width: 15%;padding: 1rem 2rem;font-weight: bold;font-size: 1rem;color: #ffffff;border: none;border-radius: 4px;outline: pointer;background: #009579;margin-bottom: 1rem;" type="submit" name="Submit" onclick="window.location.href='TambahCourt.php'">Insert New Hall</button>
</div>
