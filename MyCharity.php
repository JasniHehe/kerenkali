	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <ul>
			 <li><a style="background: #F7F7F7" href="MyCharity.php?Email=<?php echo $userEmail ?>" style="background-color:white;">Charity</a></li>
...
<form method="post" name="form1" id="form1">
  <p style="text-align: center"> My Charity List </p>
	<h3>&nbsp;</h3>
  <p align="center">
 Search Date : 
...
$sql="SELECT * FROM charity_donater WHERE email='$userEmail' and Date='$date'";
	$result = $conn->query($sql);
}
else
{
// Retrieve data from database
$sql="SELECT * FROM charity_donater WHERE email='$userEmail'";
$result = $conn->query($sql);
}
