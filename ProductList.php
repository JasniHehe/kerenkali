	...
	<nav>
		<img class="logo" src="img/logo.png" alt="">
		 ...
		 <ul>
			 ...
			 <li><a style="background: #F7F7F7" href="ProductList.php" style="background-color:white;">Products List</a></li>
			 </ul>
			 </li>
...
?>
 ...
 <td height="20"><div align="center"><?php echo $i; ?>
	  ...
	  <td><div align="center"><?php echo $rows['item']; ?></div></td>
        <td><div align="center"><a href="RemoveProduct.php?item=<?php echo $rows['item']; ?>">Delete</a></div></td>
      </tr>
